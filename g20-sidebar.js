...
(function(){
  ...
  window.G20Perfil = (function(){
    var REQ = [
      ...
      { k:'meta',            campo:'f-meta',            aba:'financeiro', rotulo:'Meta financeira principal' },
  ...
  var NAV_ITEMS = [
    ...
    { section: 'Conteúdo', cls: 'nav-section--conteudo', items: [
      ...
      { href: 'g20flix.html',            ico: '🎬', lucide: 'clapperboard',    label: 'G20Flix',        id: 'tut-flix' },
...
(function(){
  ...
  function iniciar(){
    ...
    window.addEventListener('resize', corrigirVao);
    window.addEventListener('orientationchange', function(){ setTimeout(corrigirVao, 300); });
